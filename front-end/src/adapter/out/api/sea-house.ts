...
const SEA_HOUSE_ROW_SCHEMA = z.object({
  ...
  shipperName: z.string().nullable().transform((v) => v ?? ''),
  consigneeCode: z.string().nullable().transform((v) => v ?? ''),
  consigneeName: z.string().nullable().transform((v) => v ?? ''),
  notifyCode: z.string().nullable().transform((v) => v ?? ''),
  notifyName: z.string().nullable().transform((v) => v ?? ''),
  settlePartnerCode: z.string().nullable().transform((v) => v ?? ''),
  settlePartnerName: z.string().nullable().transform((v) => v ?? ''),
  docPartnerCode: z.string().nullable().transform((v) => v ?? ''),
  docPartnerName: z.string().nullable().transform((v) => v ?? ''),
  ...
  actualCustomerName: z.string().nullable().transform((v) => v ?? ''),
  ...
  settlePartnerName: raw.settlePartnerName,
  docPartnerCode: raw.docPartnerCode,
  docPartnerName: raw.docPartnerName,
  ...
  actualCustomerName: raw.actualCustomerName,
  pkgQty: raw.pkgQty,
  pkgUnit: raw.pkgUnit,
