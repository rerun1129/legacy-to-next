...
const SEA_DETAIL_SCHEMA = z.object({
  ...
  issuePlaceName:           z.string().nullable().optional().transform((v) => v ?? undefined),
  doDate:                   z.string().nullable().optional().transform((v) => v ?? undefined),
  payableAt:                z.string().nullable().optional().transform((v) => v ?? undefined),
  payableAtName:            z.string().nullable().optional().transform((v) => v ?? undefined),
  ...
  deliveryName:             z.string().nullable().optional().transform((v) => v ?? undefined),
...
const HOUSE_BL_DETAIL_SCHEMA = HOUSE_BL_ROW_SCHEMA.extend({
  ...
  // §BE-sync — HouseBlDetailResponse name 필드 (8종)
  shipperName: z.string().nullable().optional().transform((v) => v ?? ''),
  consigneeName: z.string().nullable().optional().transform((v) => v ?? ''),
  notifyName: z.string().nullable().optional().transform((v) => v ?? ''),
  docPartnerName: z.string().nullable().optional().transform((v) => v ?? ''),
  settlePartnerName: z.string().nullable().optional().transform((v) => v ?? ''),
