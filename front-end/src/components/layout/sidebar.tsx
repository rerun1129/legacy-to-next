  ...
  sections: [
    {
      ...
      children: [
        { label: "Sea Export List",  href: "/fms/house-bl/sea-exp/list",  icon: List,     requiredMenuCode: "MENU_FMS_HOUSE_BL_SEA_EXP" },
        { label: "Sea Export Entry", href: "/fms/house-bl/sea-exp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_HOUSE_BL_SEA_EXP" },
        { label: "Sea Import List",  href: "/fms/house-bl/sea-imp/list",  icon: List,     requiredMenuCode: "MENU_FMS_HOUSE_BL_SEA_IMP" },
        { label: "Sea Import Entry", href: "/fms/house-bl/sea-imp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_HOUSE_BL_SEA_IMP" },
        { label: "Air Export List",  href: "/fms/house-bl/air-exp/list",  icon: List,     requiredMenuCode: "MENU_FMS_HOUSE_BL_AIR_EXP" },
        { label: "Air Export Entry", href: "/fms/house-bl/air-exp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_HOUSE_BL_AIR_EXP" },
        { label: "Air Import List",  href: "/fms/house-bl/air-imp/list",  icon: List,     requiredMenuCode: "MENU_FMS_HOUSE_BL_AIR_IMP" },
        { label: "Air Import Entry", href: "/fms/house-bl/air-imp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_HOUSE_BL_AIR_IMP" },
      ],
    },
    {
      group: "Master B/L", icon: Layers, defaultOpen: false, requiredMenuCode: "MENU_FMS_MASTER_BL",
      children: [
        { label: "Sea Export List",  href: "/fms/master-bl/sea-exp/list",  icon: List,     requiredMenuCode: "MENU_FMS_MASTER_BL_SEA_EXP" },
        { label: "Sea Export Entry", href: "/fms/master-bl/sea-exp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_MASTER_BL_SEA_EXP" },
        { label: "Sea Import List",  href: "/fms/master-bl/sea-imp/list",  icon: List,     requiredMenuCode: "MENU_FMS_MASTER_BL_SEA_IMP" },
        { label: "Sea Import Entry", href: "/fms/master-bl/sea-imp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_MASTER_BL_SEA_IMP" },
        { label: "Air Export List",  href: "/fms/master-bl/air-exp/list",  icon: List,     requiredMenuCode: "MENU_FMS_MASTER_BL_AIR_EXP" },
        { label: "Air Export Entry", href: "/fms/master-bl/air-exp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_MASTER_BL_AIR_EXP" },
        { label: "Air Import List",  href: "/fms/master-bl/air-imp/list",  icon: List,     requiredMenuCode: "MENU_FMS_MASTER_BL_AIR_IMP" },
        { label: "Air Import Entry", href: "/fms/master-bl/air-imp/entry", icon: FilePlus, requiredMenuCode: "MENU_FMS_MASTER_BL_AIR_IMP" },
      ],
    },
    {
