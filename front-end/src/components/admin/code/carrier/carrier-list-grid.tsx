...
import type { CarrierRow, CarrierFilter } from "@/domain/code/carrier";

interface Props {
  extraFilter: CarrierFilter | null;
  currentPage: number;
  ...
  return (
    ...
    >
      <div className="panel__head">
        ...
        <ColumnVisibilityMenu<CarrierRow> gridId="admin-code-carrier" defaultColumns={COLUMNS} />
      </div>
