...
import type { HsCodeRow, HsCodeFilter } from "@/domain/code/hs-code";

interface Props {
  extraFilter: HsCodeFilter | null;
  currentPage: number;
...
export function HsCodeListGrid({ extraFilter, currentPage, onPageChange, onRowDoubleClick, selectedKeys, onSelectionChange }: Props) {
  ...
  const { data, isFetching, error } = useQuery({
    queryKey: ["admin-code-hscode", "list", extraFilter, currentPage],
  ...
  return (
    ...
    >
      <div className="panel__head">
        ...
        <ColumnVisibilityMenu<HsCodeRow> gridId="admin-code-hscode" defaultColumns={COLUMNS} />
      </div>
