...
import type { CountryRow, CountryFilter } from "@/domain/code/country";

interface Props {
  extraFilter: CountryFilter | null;
  currentPage: number;
    ...
    return (
      <div className="panel" style={{ flex: 1, minHeight: 0, display: "flex", flexDirection: "column" }}>
        <div className="panel__head">
          ...
          <span className="panel__title">국가 관리</span>
        </div>
        <div
          className="list-wrap"
  ...
  return (
    ...
    >
      <div className="panel__head">
        ...
        <ColumnVisibilityMenu<CountryRow> gridId="admin-code-country" defaultColumns={COLUMNS} />
      </div>
