...
export interface PackageUnitFormRow {
  entityId: number;
  packageCode: string;
  name: string;
  nameEn: string;
...
export function getPackageUnitRowClassName(
  row: PackageUnitFormRow,
  original: PackageUnitFormRow[]
): string | undefined {
