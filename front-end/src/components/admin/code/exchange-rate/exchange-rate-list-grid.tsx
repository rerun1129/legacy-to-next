...
import type { ExchangeRateRow, ExchangeRateFilter } from "@/domain/code/exchange-rate";

interface Props {
  extraFilter: ExchangeRateFilter | null;
  currentPage: number;
  ...
  return (
    ...
    >
      <div className="panel__head">
        ...
        <ColumnVisibilityMenu<ExchangeRateRow> gridId="admin-code-exchange-rate" defaultColumns={COLUMNS} />
      </div>
      <div className="list-wrap">
        <GridList<ExchangeRateRow>
          columns={COLUMNS}
          data={rows}
          ...
          gridId="admin-code-exchange-rate"
        />
      </div>
      <Pagination
