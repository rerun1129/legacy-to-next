...
const NON_BL_REGISTRY: WidgetDef[] = [
  { key: "party-nonbl",          label: "Party",                 component: NonBLPartyPanel,         defaultPosition: { col: 0, row: 0, colSpan: 2, rowSpan: 2 }, minColSpan: 1, minRowSpan: 1 },
  ...
  { key: "dimension-nonbl",      label: "Dimension",             component: NonBLDimensionPanel,     defaultPosition: { col: 4, row: 0, colSpan: 2, rowSpan: 1 }, minColSpan: 1, minRowSpan: 1 },
  { key: "container-info-nonbl", label: "Container Information", component: NonBLContainerInfoPanel, defaultPosition: { col: 4, row: 2, colSpan: 2, rowSpan: 1 }, minColSpan: 1, minRowSpan: 1 },
