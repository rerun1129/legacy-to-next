...
const NON_BL_REGISTRY: WidgetDef[] = [
  { key: "party-nonbl",          label: "Party",                 component: NonBLPartyPanel,         defaultPosition: { col: 0, row: 0, colSpan: 2, rowSpan: 4 }, minColSpan: 1, minRowSpan: 1 },
  ...
  { key: "cargo-nonbl",          label: "Cargo",                 component: NonBLCargoPanel,         defaultPosition: { col: 2, row: 3, colSpan: 2, rowSpan: 3 }, minColSpan: 1, minRowSpan: 1 },
  ...
  { key: "remark-nonbl",         label: "Remark",                component: NonBLRemarkPanel,        defaultPosition: { col: 4, row: 4, colSpan: 2, rowSpan: 2 }, minColSpan: 1, minRowSpan: 1 },
];
