...
const TRUCK_REGISTRY: WidgetDef[] = [
  ...
  { key: "marks-truck",       label: "Marks & Numbers", component: MarksPanel,       defaultPosition: { col: 0, row: 6, colSpan: 2, rowSpan: 3 }, minColSpan: 1, minRowSpan: 1 },
  { key: "description-truck", label: "Description",    component: DescriptionPanel, defaultPosition: { col: 2, row: 6, colSpan: 2, rowSpan: 3 }, minColSpan: 1, minRowSpan: 1 },
];
