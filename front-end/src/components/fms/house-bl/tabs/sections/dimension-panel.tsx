...
interface DimRow { length: string; width: string; height: string; qty: string; cbm: string; volWt: string; }
...
const DATA: DimRow[] = [
  ...
  { length: "150", width: "100", height: "120", qty: "50",   cbm: "22.5",  volWt: "3750"  },
  { length: "60",  width: "50",  height: "40",  qty: "500",  cbm: "6.0",   volWt: "1000"  },
  { length: "200", width: "120", height: "150", qty: "20",   cbm: "72.0",  volWt: "12000" },
  { length: "80",  width: "60",  height: "50",  qty: "300",  cbm: "7.2",   volWt: "1200"  },
];
...
export function DimensionPanel() {
  return (
    <div className="panel" style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <GridList columns={COLS} data={DATA} rowKey={(_, i) => i} style={{ flex: 1, minHeight: 0 }} />
    </div>
  );
}
