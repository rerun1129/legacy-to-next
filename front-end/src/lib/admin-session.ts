...
export function firstAccessibleRoute(session: AdminSession): string | null {
  const order: Array<[string, string]> = [
    ...
    ["MENU_FMS_HOUSE_BL_SEA_EXP", "/fms/house-bl/sea-exp/list"],
    ["MENU_FMS_HOUSE_BL_SEA_IMP", "/fms/house-bl/sea-imp/list"],
    ["MENU_FMS_HOUSE_BL_AIR_EXP", "/fms/house-bl/air-exp/list"],
    ["MENU_FMS_HOUSE_BL_AIR_IMP", "/fms/house-bl/air-imp/list"],
    ["MENU_FMS_MASTER_BL_SEA_EXP", "/fms/master-bl/sea-exp/list"],
    ["MENU_FMS_MASTER_BL_SEA_IMP", "/fms/master-bl/sea-imp/list"],
    ["MENU_FMS_MASTER_BL_AIR_EXP", "/fms/master-bl/air-exp/list"],
    ["MENU_FMS_MASTER_BL_AIR_IMP", "/fms/master-bl/air-imp/list"],
