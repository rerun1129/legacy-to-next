...
public class HsCode extends BaseEntity {
    ...
    private HsCode(String hsCode, String name, String nameEn, String countryCode, boolean active) {
        this.hsCode      = hsCode;
        this.name        = name;
        this.nameEn      = nameEn;
    ...
    public static HsCode create(String hsCode, String name, String nameEn, String countryCode, boolean active) {
        return new HsCode(hsCode, name, nameEn, countryCode, active);
    }

    /**
     * 수정 가능한 필드만 갱신. 식별 필드(hsCode)는 변경 불가.
     */
    public void applyUpdate(String name, String nameEn, String countryCode, boolean active) {
        this.name        = name;
        this.nameEn      = nameEn;
        this.countryCode = countryCode;
        this.active      = active;
