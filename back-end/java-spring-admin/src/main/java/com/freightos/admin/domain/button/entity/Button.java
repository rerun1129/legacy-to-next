...
public class Button extends BaseEntity {
    ...
    private Button(String buttonCode, Long menuId, String label, ActionType actionType,
    ...
    public static Button create(String buttonCode, Long menuId, String label, ActionType actionType,
                                String apiMethod, String apiPath, Integer sortOrder, Boolean active) {
        return new Button(buttonCode, menuId, label, actionType, apiMethod, apiPath, sortOrder, active);
    }
