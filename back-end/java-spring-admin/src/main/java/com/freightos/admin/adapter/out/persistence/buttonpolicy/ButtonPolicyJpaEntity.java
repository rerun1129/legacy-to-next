...
@Entity
@Table(schema = "admin", name = "button_policy",
        uniqueConstraints = @UniqueConstraint(columnNames = {"button_id", "attribute_key", "required_value"}))
@Getter
@Setter
@NoArgsConstructor
public class ButtonPolicyJpaEntity extends BaseJpaEntity {
