...
public class UserRepositoryImpl implements UserRepositoryCustom {
    ...
    public PagedResult<UserSummary> searchSummaries(SearchUserCommand command) {
        ...
        List<UserSummary> content = typedQuery.getResultList().stream()
                .map(e -> new UserSummary(e.getId(), e.getUsername(), e.getEmail(), e.getActive(), e.getDeletedAt(), e.getUpdatedAt(), parseAttributes(e.getAttributes()), e.getTeamId(), e.getSubscriberId()))
                .toList();
