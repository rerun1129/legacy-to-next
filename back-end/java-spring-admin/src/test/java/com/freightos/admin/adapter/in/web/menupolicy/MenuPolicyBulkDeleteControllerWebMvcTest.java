...
@WebMvcTest(controllers = MenuPolicyController.class)
@Import({ SecurityConfig.class, JwtAuthenticationFilter.class })
class MenuPolicyBulkDeleteControllerWebMvcTest {
    ...
    @MockitoBean
    private MenuPolicyUseCase menuPolicyUseCase;

    @MockitoBean
    private MenuPolicyAssembler menuPolicyAssembler;
    ...
    void bulkDelete_unauthenticated_returns401() throws Exception {
        ...
        mockMvc.perform(delete("/api/admin/access/menu-policy/bulk")
    ...
    void bulkDelete_validRequest_returns200() throws Exception {
        willDoNothing().given(menuPolicyUseCase).deleteMenuPoliciesByIds(any());
