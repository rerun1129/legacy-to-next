...
public interface HouseBlNonBlDimRepository extends JpaRepository<HouseBlNonBlDimJpaEntity, Long> {

    @Modifying(flushAutomatically = true)
    @Query("delete from HouseBlNonBlDimJpaEntity d " +
           "where d.houseBlNonBlId in (" +
