...
public class AttachmentCleanupScheduler {
    ...
    public void cleanOrphanFiles() {
        ...
        List<StoragePort.StoredObject> storageObjects = storagePort.list();
        ...
        Set<String> storageKeys = storageObjects.stream().map(StoragePort.StoredObject::key).collect(java.util.stream.Collectors.toSet());
