...
@Getter
@NoArgsConstructor
public class HouseBlSeaDescJpaEntity extends BaseJpaEntity {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "house_bl_sea_desc_id", updatable = false, nullable = false)
    ...
    public void setHouseBlSeaDescId(Long v) { this.houseBlSeaDescId = v; }
    public void setSea(HouseBlSeaJpaEntity v) { this.sea = v; }
