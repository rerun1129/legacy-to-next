 ...
 * freight 변환은 NonBlFreightAssembler에 위임한다.
 */
@Component
public class NonBlAssembler {

    private final NonBlFreightAssembler nonBlFreightAssembler;

    public NonBlAssembler(NonBlFreightAssembler nonBlFreightAssembler) {
        this.nonBlFreightAssembler = nonBlFreightAssembler;
    }
    ...
    public CreateHouseBlCommand toCreateCommand(CreateNonBlRequest req) {
        CreateHouseBlCommand.FreightCommand freight = nonBlFreightAssembler.toCreateFreightCommand(req);
    ...
    public UpdateHouseBlCommand toUpdateCommand(UpdateNonBlRequest req) {
        UpdateHouseBlCommand.FreightCommand freight = nonBlFreightAssembler.toUpdateFreightCommand(req);
