...
public interface MasterBlScheduleLegRepository extends JpaRepository<MasterBlScheduleLegJpaEntity, Long> {

    @Modifying(flushAutomatically = true)
    @Query("delete from MasterBlScheduleLegJpaEntity l " +
           "where l.masterBlAirId in (" +
